...
def validate_empic_payment_participant_binding(
    ...
    for ev in audit:
        ...
        if event_type in {
            ...
            missing = [field_name for field_name, value in observed.items() if not value]
            if missing:
        ...
        for field_name, value in observed.items():
            ...
            if existing is not None and existing != value:
                violations.append(f"{ref}: {field_name} changed from {existing} to {value}")
            else:
...
# ---------------------------------------------------------------------------
# Outcome-verified settlement validators
# ---------------------------------------------------------------------------
