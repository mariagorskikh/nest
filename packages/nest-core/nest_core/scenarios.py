...
def _try_load_builtin(name: str) -> None:
    ...
    elif name == "convergent_auth":
        from nest_core.scenarios_builtin.convergent_auth import convergent_auth_factory

        register_scenario("convergent_auth", convergent_auth_factory)
