...
def _try_load_builtin(name: str) -> None:
    ...
    elif name == "fair_ordering":
        from nest_core.scenarios_builtin.fair_ordering import (
            fair_ordering_factory,
        )

        register_scenario("fair_ordering", fair_ordering_factory)
