...
def _try_load_builtin(name: str) -> None:
    ...
    elif name == "memory_or_set_writers":
        from nest_core.scenarios_builtin.memory_or_set_writers import (
            memory_or_set_writers_factory,
        )

        register_scenario("memory_or_set_writers", memory_or_set_writers_factory)
